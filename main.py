...
from view_transformer import ViewTransfomer
...
def main():
    ...
    tracks=tracker.get_object_tracks(video_frames,
                                     read_from_stub=True,
                                     stub_path="stubs/track_stubs_v4.pkl")
    ...
    view_transformer=ViewTransfomer()
    ...
    save_video(output_video_frames, "output_videos/output_video_new1.mp4")
